// The 404 page. Also the resting place of flag part 3/3 - printed
...
export default function NotFound() {
  return (
    ...
    >
      ...
      <p className="meta mt-6">or press ~ for the shell</p>
    </main>
  )
}
